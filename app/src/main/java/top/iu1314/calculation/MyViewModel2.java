...
public class MyViewModel2 extends AndroidViewModel {
    ...
    private static String KEY_CURRENT_HIGH_SCORE = "key_current_high_score";
    ...
    public MyViewModel2(@NonNull Application application, SavedStateHandle handle) {
        super(application);
    ...
    public MutableLiveData<Integer> getCurrentScore() {
        return handle.getLiveData(KEY_CURRENT_HIGH_SCORE);
    }
